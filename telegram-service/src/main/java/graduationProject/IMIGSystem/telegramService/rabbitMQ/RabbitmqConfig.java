...
public class RabbitmqConfig {
    ...
    public static final String TELEGRAM_QUEUE = "IM-Integration-System.TELEGRAM";
    ...
    public Queue lineQueue() {
        return new Queue(TELEGRAM_QUEUE,false);
    }
    @Bean
    public Binding bindingLineQueue(@Qualifier("IMIG_IPS") TopicExchange exchange) {
        return BindingBuilder.bind(lineQueue()).to(exchange).with(TELEGRAM_QUEUE);
    }
