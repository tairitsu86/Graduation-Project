...
INSERT INTO [customize_event] (event_name,[description],api_method,url_template,request_body_template)
	SELECT 'LOGIN','Login','POST','http://user-database-service:8000/login','{"username": "${USERNAME}","password": "${PASSWORD}","fromPlatform": "${PLATFORM}","platformType":"Instant-Messaging","platformUserId":"${USER_ID}"}'
